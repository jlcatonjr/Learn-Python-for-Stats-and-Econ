...
list2 = [1,1,1,1,5]
covPopList1List2 = covariance(list1, list2, sample = False)
covSamList1List2 = covariance(list1, list2, sample = True)
print("Covariance of population:", covPopList1List2)
print("Covariance of sample:", covSamList1List2)

corrList1List2 = correlation(list1, list2)
print("Correlation of list1 and list2:", corrList1List2)