...
list_dict = {}
list_dict[1] = {}
list_dict[1]["list"] = list1
list_dict[2] = {}
list_dict[2]["list"] = list2

for key in list_dict:
    lst = list_dict[key]["list"]
    list_dict[key]["total"] = total(lst)
    list_dict[key]["mean"] = mean(lst)
    list_dict[key]["median"] = median(lst)
    list_dict[key]["mode"] = mode(lst)
    list_dict[key]["variance"] = variance(lst)
    list_dict[key]["standard deviation"] = SD(lst)  
