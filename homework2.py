...
# the elements in order of index. hint: result sould be like "36912..."

#4 Using .pop() and .append(), create a list whose values are the same 
# as the list from question 1 but in reverse order
