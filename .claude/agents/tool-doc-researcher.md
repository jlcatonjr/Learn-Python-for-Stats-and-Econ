...
- **mpl_toolkits** (reference file `references/ref-mpltoolkits-reference.md`) — missing: docs URL, API surface, usage patterns
- **voila** (reference file `references/ref-voila-reference.md`) — missing: docs URL, API surface, usage patterns
